...
public class PushHelper {
	 ...
	 * @param callback
	 */
	public void sendRegistId(Context ctx, String regId, Map<String, Object> attr) {
	...
	protected void saveRegist(String registrationID) throws IOException {
	...
	public void removeRegistrationID(Context ctx) throws IOException {
		String mRemoveWebURL = String.format("%s/%s/%s/%s",
				Constants.RESGISTER_REGISTRATION_URL,
